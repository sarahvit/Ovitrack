...
export function Slide() {
    ...
    return (
        <div  className="w-full shadow-[0px_10px_20px_rgba(0,0,0,0.20)] z-10">
        <div className="relative w-full h-[354px]  overflow-hidden bg-linear-to-r from-[#1a2b5e] to-[#2d4a8f]">
            ...
            <button
                onClick={prevSlide}
                className="absolute left-6 top-1/2 -translate-y-1/2 z-20 bg-white/20 hover:bg-white/30 text-white rounded-full p-3 ml-10 transition-all"
            >
            ...
            <button
                onClick={nextSlide}
                className="absolute right-6 top-1/2 -translate-y-1/2 z-20 bg-white/20 hover:bg-white/30 text-white rounded-full p-3 transition-all mr-8"
            >
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
